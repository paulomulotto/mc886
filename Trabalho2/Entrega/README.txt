...
Caso opte por colocar os datasets em outra pasta, basta alterar as variáveis name (linha 300 na Main.py) e name_test (linha 309 na Main.py) para os caminhos que levam aos arquivos de treino e teste, respectivamente.
